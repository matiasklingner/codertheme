...
#Los decorators sirven para vistas basadas en funciones
from django.contrib.auth.decorators import login_required

#Ejemplo
#@decorador
#def funcion_a_proeger
...
def actualizar_profesor(request, profesor_id):
    ...
    return render(request,'actualizar_profesor.html', {'formulario': CrearProfesorForm})
...
class CursoDeleteView(LoginRequiredMixin, DeleteView):
    ...
    #En success_url utilizar el nombre de la url
    #Ejemplo:
...
class CursoUpdateView(UpdateView):
    ...
    #fields colocamos en una lista los nombres de los parametros utilizados
    model = Curso
    success_url = '/cursos_list'
